...
val t1 = interp(emptyenv, parsestr test1);
val t2 = interp_static(emptyenv2, parsestr test1);

(*interp(emptyenv, parsestr test2);*)
interp_static(emptyenv2, parsestr test2); (*works gives 100*)

(*interp(emptyenv, parsestr test3);*)
(*interp_static(emptyenv2, parsestr test3);

(*interp(emptyenv, parsestr test4);*)
interp_static(emptyenv2, parsestr test4);

(*interp(emptyenv, parsestr test5);*)
interp_static(emptyenv2, parsestr test5);

interp(emptyenv, parsestr test6);
interp_static(emptyenv2, parsestr test6);

(*interp(emptyenv, parsestr test7);*)
interp_static(emptyenv2, parsestr test7);

(*interp(emptyenv, parsestr test8);*)
interp_static(emptyenv2, parsestr test8);*)
